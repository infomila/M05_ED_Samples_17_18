...
implements CirculinearContinuousCurve2D, CirculinearContour2D {
     ...
     */
    public static <T extends CirculinearContinuousCurve2D> 
    BoundaryPolyCirculinearCurve2D<T> createBoundaryPolyCirculinearCurve2D(T... curves) {
    	return new BoundaryPolyCirculinearCurve2D<T>(curves);
    }
	...
	reverse() {
    	int n = curves.size();
        // createPolyCirculinearCurve2D array of reversed curves
        ...
        // createPolyCirculinearCurve2D the reversed final curve
	...
	transform(AffineTransform2D trans) {
		...
		// createPolyCirculinearCurve2D result curve
