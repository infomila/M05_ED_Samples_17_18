...
public class MultiPolygon2D implements Domain2D, Polygon2D {
    ...
    public CirculinearContourArray2D<LinearRing2D> boundary() {
        return CirculinearContourArray2D.createCirculinearContourArray2D(rings);
    }
    ...
    public Polygon2D complement() {
        ...
        // createCirculinearContourArray2D the new MultiMpolygon2D with set of reversed rings
    ...
    public MultiPolygon2D clone() {
        ...
        // createCirculinearContourArray2D a new polygon with cloned rings
