...
public class CirculinearCurves2D {
	...
	public static CirculinearCurve2D convert(Curve2D curve) {
		...
		if (curve instanceof ContinuousCurve2D) {
			...
			// createPolyCirculinearCurve2D the resulting CirculinearContinuousCurve2D
		...
		if (curve instanceof CurveSet2D<?>) {
			...
			// createPolyCirculinearCurve2D the resulting CirculinearContinuousCurve2D
			return CirculinearCurveArray2D.createCirculinearCurveArray2D(curves);
		}
	...
	public static Collection<Point2D> findSelfIntersections(
		...
		// createPolyCirculinearCurve2D array of circulinear elements
		ArrayList<CirculinearElement2D> elements = new ArrayList<CirculinearElement2D>();
		...
		// createPolyCirculinearCurve2D array for storing result
	...
	public static Collection<Point2D> findIntersections(
		...
		// createPolyCirculinearCurve2D array for storing result (max 2 possible intersections)
	...
	public static Collection<CirculinearContinuousCurve2D> splitContinuousCurve(
		...
		// createPolyCirculinearCurve2D the array of resulting curves
		...
		if (couples.length == 0) {
			// createPolyCirculinearCurve2D continuous curve formed only by circulinear elements
		...
		// createPolyCirculinearCurve2D new empty array of elements for current continuous curve
	...
	public static Collection<CirculinearContour2D> splitIntersectingContours(
		...
		while (!twins1.isEmpty()) {
			// createPolyCirculinearCurve2D new empty array of elements for current contour
			elements = new ArrayList<CirculinearElement2D>();
