...
public class CirculinearDomains2D {
	...
	public final static CirculinearDomain2D computeBuffer(
		...
		// All the rings are created, we can now createCirculinearCurveArray2D a new domain with the
		// set of rings
	...
	computeBufferSimpleRing(CirculinearContour2D curve, double d) {
		...
		// createCirculinearCurveArray2D a new boundary for each parallel curve
