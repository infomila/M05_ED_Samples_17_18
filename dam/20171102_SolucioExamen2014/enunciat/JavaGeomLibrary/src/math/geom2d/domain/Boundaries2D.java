...
public abstract class Boundaries2D {
    ...
    clipContinuousOrientedCurve(ContinuousOrientedCurve2D curve, Box2D box) {
    	...
    	// createBoundaryPolyCurve2D result array
        ...
        // // createBoundaryPolyCurve2D array of points
    ...
    public final static ContourArray2D<Contour2D> clipBoundary(
        ...
        // also createBoundaryPolyCurve2D array of curves
		...
		while (c < nb) {
            ...
            // createBoundaryPolyCurve2D a new Boundary curve
