...
public class PolyCurve2D<T extends ContinuousCurve2D> extends CurveArray2D<T>
     ...
     * @since 0.8.1
     */
    public static <T extends ContinuousCurve2D> PolyCurve2D<T> createPolyCurve2D(
    		Collection<T> curves) {
    ...
    private static Collection<SmoothCurve2D> getSmoothCurves(Curve2D curve) {
    	// createPolyCurve2D array for result
   ...
   @Override
    public PolyCurve2D<? extends ContinuousCurve2D> reverse() {
    	// createPolyCurve2D array for storing reversed curves
    	int n = curves.size();
        ...
        // createPolyCurve2D the new reversed curve
    ...
    public PolyCurve2D<? extends ContinuousCurve2D> subCurve(double t0,
        ...
        // createPolyCurve2D result object, with appropriate numbe of curves
