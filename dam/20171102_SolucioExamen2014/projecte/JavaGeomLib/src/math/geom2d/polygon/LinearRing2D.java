...
public class LinearRing2D extends LinearCurve2D implements CirculinearRing2D {
	...
	public Collection<LineSegment2D> edges() {
		// createGenericCirculinearRing2D resulting array
		int n = vertices.size();
		...
		// createGenericCirculinearRing2D one edge for each couple of vertices
		for (int i = 0; i < n - 1; i++)
	...
	public CirculinearRing2D transform(CircleInversion2D inv) {
		...
		// createGenericCirculinearRing2D the transformed shape
