 ...
 * <blockquote><pre>
 * {@code 
 * // createCirculinearCurveArray2D two orthogonal lines
 ...
 CirculinearCurveSet2D<StraightLine2D> set = 
     CirculinearCurveArray2D.createCirculinearCurveArray2D(line1, line2);
 }
 * </pre></blockquote>
 * @author dlegland
 *
...
extends CurveArray2D<T> implements CirculinearCurveSet2D<T> {
     ...
     * @since 0.8.1
     */
    public static <T extends CirculinearCurve2D> CirculinearCurveArray2D<T> createCirculinearCurveArray2D(
    		Collection<T> curves) {
    ...
    continuousCurves() {
    	// createCirculinearCurveArray2D array for storing result
