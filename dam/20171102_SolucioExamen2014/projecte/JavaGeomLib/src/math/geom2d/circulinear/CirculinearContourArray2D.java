 ...
 *	CirculinearContourArray2D<Circle2D> array =
      CirculinearContourArray2D.createCirculinearCurveArray2D(new Circle2D[]{circle1, circle2});
 </code></pre>
 * @author dlegland
 *
 */
...
extends ContourArray2D<T> implements CirculinearBoundary2D {
	...
	CirculinearContourArray2D<T> createCirculinearContourArray2D(Collection<T> curves) {
     ...
     */
    public static <T extends CirculinearContour2D> 
    CirculinearContourArray2D<T> createCirculinearContourArray2D(T... curves) {
    	return new CirculinearContourArray2D<T>(curves);
    }
	...
	reverse(){
    	int n = curves.size();
        // createCirculinearCurveArray2D array of reversed curves
        ...
        // createCirculinearCurveArray2D the reversed final curve
    ...
    public CirculinearCurveSet2D<? extends CirculinearContinuousCurve2D> subCurve(
        ...
        // createCirculinearCurveArray2D subcurve array
